...
class Converter:
    ...
    def __init__(self):
        ...
        self.all_calculations_list = ['$10.00 NZD is ¥924 JPY', '$20.00 NZD is ¥1848 JPY',
                                      '$30.00 NZD is ¥2772 JPY', '$40.00 NZD is ¥3696 JPY',
                                      '$50.00 NZD is ¥4620 JPY', 'This is a test']
...
class HistoryExport:
    ...
    def export_data(self, calculations):
        ...
        # Open save dialog so user can choose filename and location
        ...
        if file_path:
            # Get current date for file heading
            today = date.today()
            ...
            with open(file_path, "w") as text_file:
                text_file.write("***** Currency Conversion History (NZD <-> JPY) ******\n")
